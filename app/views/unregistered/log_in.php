...
?>
  ...
  <head>
    ...
    <title>LOGIN</title>
    <style>
      <?php include '../../../public/css/unregistered/log_in.css'; ?>
    </style>
    <style>
      <?php include '../../../public/css/unregistered/repeating_css.css'; ?>
    </style>
    ...
    <section class="log_in">
      ...
      <div class="box-log_in">
        ...
        <div class="border-img-log_in">
          <img class="img-log_in" src="../../../public/images/icons/log_in.png" alt="SIGN UP">
        </div>
        <div class="description-log_in">
          <form class="" id="log_in_form" action="../../php/unregistered/end-log_in.php" method="post">
            <div class="username-div-log_in">
              <img class="img-username-div-log_in" src="../../../public/images/icons/user.png" alt="">
              <input class="text-log_in" type="text" name="username" id="username" placeholder="Username...">
            </div>
            <div class="username-div-log_in">
              <img class="img-username-div-log_in" src="../../../public/images/icons/password.png" alt="">
          ...
          <h3><a href="../unregistered/forgot_pw_step1.php">Forgot Password...?</a></h3>
          <h3><a href="../unregistered/sign_up.php">New to Travo.lk...?</a></h3>
        </div>
    </section>
  </body>
