    ...
    '<div class="nav_bar-div">
      ...
      <nav class = "nav_bar">
        ...
        <ul class="nav_bar_links">
          ...
          <li class="navigations_name"></li>
          <li class="navigations_name"><a href="../vehicle/vehicle_home.php">HOME</a></li>
          <li class="navigations_name"><a href="../vehicle/vehicle_faq.php">FAQ</a></li>
          <li class="navigations_name"><a href="../vehicle/vehicle_home.php#about_us-section">ABOUT</a></li>
          <li class="navigations_name"><a href="#contact_us-section">CONTACT</a></li>
          <li class="navigations_name"><a href="../vehicle/vehicle_view_vehicle.php">MY VEHICLES</a></li>
          <li class="navigations_name"><a href="../vehicle/vehicle_addnew.php">ADD VEHICLE</a></li>
          <li class = "dropdown_li"> 
            <div class="dropdown">
              ...
              <div class="dropdown-content">
                  ...
                  <div class="drop-box"><a class="drop-nav" href=../vehicle/vehicle_update.php>UPDATE</a></div>
        ...
        <li class="navigations_name drop_content_mini"><a class="drop-nav" href=../vehicle/vehicle_update.php>UPDATE</a></li>
