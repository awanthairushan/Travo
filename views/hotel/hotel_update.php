...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php include_once APPROOT.'/views/repeatable_contents/nav_bar_hotel.php';?>
      ...
      <form class="form-sign_up-traveler" id = "sign_up_form-hotel" name="sign_up_form-hotel" action="updateHotel" method="post" enctype="multipart/form-data">

      <?php while($rows = mysqli_fetch_array($this->isHotel) ){ ?>

      <div class="form-control">
      <label for="name">Hotel Name</label> <input class="text-form-sign_up-traveler" type="text" name="name" id="name" value="" placeholder="<?php echo $rows['name']; ?>" ><br>
      <br>
      ...
      <label for="regNO">Registration Number</label> <input class="text-form-sign_up-traveler" type="text" name="regNO" id="regNO" value="" placeholder="<?php echo $rows['regNo']; ?>"><br>
      <br>

      <label for="licenceNo">Licence Number</label> <input class="text-form-sign_up-traveler" type="text" name="licenceNo" id="licenceNo" value="" placeholder="<?php echo $rows['licenceNo']; ?>"><br>
      <br>

      <div class="form-control">
      <label for="adress">Address</label> 
      <input class="text-form-sign_up-traveler" type="text" name="address-line1" id="address-line1" placeholder="<?php echo $rows['address_line1']; ?>"  ></br>
      <br>
      <input class="text-form-sign_up-traveler" type="text" name="address-line2" id="address-line2" placeholder="<?php echo $rows['address_line2']; ?>"  ></br>
      <br>
      <input class="text-form-sign_up-traveler" type="text" name="city" id="city" placeholder="<?php echo $rows['city']; ?>"></br>
      <br>
        <span class="error-msg"></span>
      </div>
      ...
      <input class="text-form-sign_up-traveler" type="url" name="location" id="location" placeholder="<?php echo $rows['location']; ?>"></br>
      </div>
      <br>
        <span class="error-msg"></span>
      </div>
      ...
      <label for="contact">Contact Number</label> 
        <input class="text-small-form-sign_up-traveler" type="text" name="contact2" id="contact2" value="" placeholder="<?php echo $rows['contact2']; ?>">
        <input class="text-small-form-sign_up-traveler" type="text" name="contact1" id="contact1" value=""  placeholder="<?php echo $rows['contact1']; ?>"></br>
        <br>
        <span class="error-msg"></span>
      </div>
      ...
      <label for="email">Email Address</label> 
        <input class="text-form-sign_up-traveler" type="text" name="email" id="email" value=""  placeholder="<?php echo $rows['email']; ?>"></br>
        <br>
        <span class="error-msg"></span>
      </div>
      ...
      <textarea class="description-form-hotel" id="description" name="description" rows="8" cols="80" maxlength="500" placeholder="<?php echo $rows['description']; ?>"></textarea ></br>
      <br><br><br>
        <span class="error-msg"></span>
      </div>
      ...
      <input class="text-form-sign_up-traveler" type="text" name="web" id="web" value=""  placeholder="<?php echo $rows['webUrl']; ?>"></br>
      <br>
      </div>
        <span class="error-msg"></span>
      </div>
      ...
      <input class="text-form-sign_up-traveler" type="text" name="rep_name" id="rep_name" value="" placeholder="<?php echo $rows['rep_name']; ?>"></br>
      <br>
        <span class="error-msg"></span>
      </div>
      ...
      <input class="text-form-sign_up-traveler" type="text" name="rep_email" id="rep_email" value="" placeholder="<?php echo $rows['rep_email']; ?>"></br>
      <br>
        <span class="error-msg"></span>
      </div>
      ...
      <input class="text-small-form-sign_up-traveler" type="text" name="rep_contact2" id="rep_contact2" value="" placeholder="<?php echo $rows['rep_contact2']; ?>">
      <input class="text-small-form-sign_up-traveler" type="text" name="rep_contact1" id="rep_contact1" value="" placeholder="<?php echo $rows['rep_contact1']; ?>"></br>
      <br>
        <span class="error-msg"></span>
      </div>
