                    ...
                    <?php 
                        ...
                        <div class="location_div">
                          <label for="location">LOCATION:</label>
                            <div class="mapform" >
                                ...
                                <script>
                                    ...
                                    function initMap() {
                                        map = new google.maps.Map(document.getElementById("map"), {
                                            center: { lat: 6.902206909028085, lng: 79.86114263534546 },
                                            zoom: 8,
                                            scrollwheel: true,
                                        });
                                        const lanka = { lat: 6.902206909028085, lng: 79.86114263534546 };
                                ...
                                <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDD3nYBp26uWK_F_-K4mKLfQpVKAGRHgz0&callback=initMap"
                                        type="text/javascript"></script>
                            </div>

                          <div class="clear"></div>
                          <div id="displaydiv" class="displaydiv"> Select up to <?php echo $_SESSION['difference']+1; ?> destinations</div>
                        ...
                        <div id="destinations">
                            <table class="tableday">
                                <tr><td class="tdata"><label for="destination1">DESTINATION <?php echo $i; ?></label></td></tr>
                                <tr><td class="tdata"><button type="button" class="selecthotelpopupbtn"> <?php echo $hotel; ?> NIGHT HOTEL</button></td></tr>
                                <tr>
                                    <td class="tdata">
